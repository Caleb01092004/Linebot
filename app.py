            ...
            image_carousel_template = ImageCarouselTemplate(
                columns=[
                    ImageCarouselColumn(
                        ...
                        image_url='https://linebot-wpp0.onrender.com/static/Lotus.png',
                        action=PostbackAction(
                            label='《蓮花開～祝你有美好的一天》',
                            data = 'task1'
                        )
                    ...
                    ImageCarouselColumn(
                        ...
                        image_url='https://linebot-wpp0.onrender.com/static/Muu.png',
                        action=PostbackAction(
                            label='《Muu\（姆\)》',
                            data = 'task2'
                        )
                    ...
                    ImageCarouselColumn(
                        ...
                        image_url='https://linebot-wpp0.onrender.com/static/ReStyle.png',
                        action=PostbackAction(
                    ...
                    ImageCarouselColumn(
                        ...
                        image_url='https://linebot-wpp0.onrender.com/static/Phone.png',
                        action=PostbackAction(
